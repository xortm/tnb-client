...
export default Ember.Controller.extend(InfiniteScroll,{
  ...
  infiniteModelName: "",
  infiniteContainerName:"userBodyPulseContainer",
  ...
  queryFlagIn: function(){
    ...
    _self.store.query("healthAnalysis",{
      filter:{"[customer][id]":curCustomerId,"[type][typecode]":"healthExamType3"},
  ...
  showChartData() {
        ...
        var bodyPulse = _self.get("bodyPulse");
        //重新定义
    ...
    initChart() {
        ...
        $("#bodyPulse").width(pwHeart);
        var bodyPulse = Echarts.init(document.getElementById('bodyPulse'));
        this.set("bodyPulse", bodyPulse);
