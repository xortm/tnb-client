...
export default Ember.Controller.extend(InfiniteScroll, {
    ...
    infiniteContainerName: "marketskillEditContainer",
    ...
    queryObs: function() {
        App.lookup('route:business.mainpage.marketskill-edit-mobile').doQuery();
    }.observes("source"),
    ...
    // listenner: function() {
    //     this.get('feedService').on('saveFun_save_ms', this, 'save');
    // }.on('init'),
    ...
    actions: {
        ...
        save() {
            ...
            if ((source === "title" || source === "remark") && (edit === null || edit.length === 0)) {
                ...
                var consultinfo = this.get("store").peekRecord('market-skill', infoId);
                if (source === "title") {
                ...
                consultinfo.save().then(function() {
                    ...
                    var mainController = App.lookup("controller:business.mainpage");
                    mainController.switchMainPage("marketskill-detail-mobile",params);
        ...
        inPreferenceSelect: function(sourceDict) {
            ...
            consultInfo.save().then(function() {
                var mainController = App.lookup("controller:business.mainpage");
                mainController.switchMainPage("marketskill-detail-mobile");
            });
        },
