...
export default Ember.Controller.extend(InfiniteScroll,{
  ...
  infiniteModelName: "",
  infiniteContainerName:"jujiaPasswordContainer",

  service_PageConstrut:Ember.inject.service("page-constructure"),
  mainController: Ember.inject.controller('business.mainpage'),
  queryFlagIn: function(){return;},
  actions:{
    jujiaPassword: function(){
      $("#jujiaPassword").addClass("tapped");
      setTimeout(function(){$("#jujiaPassword").removeClass("tapped");},200);
      ...
      console.log("1111111  jinru111 passcode",curUser.get("passcode"));
      var newPsd = this.get('newPass');
      console.log("newPass11111",$.md5(newPsd));
