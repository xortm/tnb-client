...
export default Ember.Controller.extend(DeviceValidations,{
  ...
  actions:{
    exportToAllExcel(){
      ...
      let params = App.lookup("route:business.mainpage.device-set-detail").pagiParamsSet();
      ...
      App.lookup("route:business.mainpage.device-set-detail").set('perPage',9999);
      App.lookup("route:business.mainpage.device-set-detail").findPaged('device',params,function(deviceList){
        App.lookup("route:business.mainpage.device-set-detail").setDeviceBind(deviceList);
    ...
    delDevice(device){
      ...
      device.save().then(function(){
          App.lookup("route:business.mainpage.device-set-detail").doQuery('search');
      },function(err){
