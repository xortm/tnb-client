...
export default Ember.Controller.extend({
    ...
    actions: {
        enterDetail: function(staff) {
            ...
            this.get("mainController").switchMainPage('employee-management-detail',params);
        },
        /*删除*/
        ...
        statusSelect:function(currentDict){
          if(currentDict){
            this.set("staffStatusId",currentDict.get("id"));
          }else{
            this.set("staffStatusId","");
          }
           App.lookup("route:business.mainpage.employee-management").doQuery();
        }
    }
});
