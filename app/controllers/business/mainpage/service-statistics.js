...
export default Ember.Controller.extend({
  ...
  actions: {
    selectEmployee(employee){
      ...
      if(!employee){
        this.set("employeeArr",this.get("employeeList"));
      }else{
        let employeeArr = new Ember.A(); //构建数组
        employeeArr.push(employee);
        console.log("employeeArr in select:",employeeArr);
        this.set('employeeArr',employeeArr);
      }
      this.incrementProperty("doQueryFlag");
    },
    bigClick(){
