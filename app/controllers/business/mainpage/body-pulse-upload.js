...
export default Ember.Controller.extend(InfiniteScroll,{
  infiniteContentPropertyName: "userBloodPulseUpload",
  infiniteModelName: "user",
  infiniteContainerName:"userBloodPulseUploadContainer",
  ...
  actions:{
    ...
    saveItem:function(){
      ...
      if ('undefined' === typeof(curValue) || '' === curValue) {
        App.lookup("controller:business").popTorMsg("脉搏数值不能为空!");
          return ;
      }
      ...
      var typeObj = this.get("dataLoader").findDict(Constants.healthExamType3);
      ...
      healthInfo.save().then(function(){
        App.lookup("controller:business").popTorMsg("脉搏数值上传成功!");
        App.lookup('controller:business.mainpage').switchMainPage('body-pulse');
      });
      //  清空页面的input输入框
      this.set('curValue', "");
    },
