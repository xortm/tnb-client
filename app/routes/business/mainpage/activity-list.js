...
export default BaseBusiness.extend(Pagination, {
    ...
    buildQueryParams: function() {
        ...
        if (curController) {
            ...
            if (conBeginDate && conEndDate) {
                ...
                filter = $.extend({}, filter, {
                    'holdTime@$gte': beginCompare
                }, {
                    'holdTime@$lte': endCompare
                });
            }
        }
    ...
    doQuery: function() {
        ...
        var holdInfoList = this.findPaged('activity-hold-info', params, function(holdInfoList) {});
        this.getCurrentController().set("holdInfoList", holdInfoList);
    },
